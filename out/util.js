...
exports.webSearchByGithub =
  exports.webSearchByStackOverflow =
  exports.webSearchByDuckDuckGo =
  exports.webSearchByGoogle =
    void 0;
...
function webSearch(configSection) {
  ...
  const queryTemplate = searchBuddyCfg.get(config_1.CFG_QUERY);
...
function webSearchByGoogle() {
  webSearch(config_1.ConfigSections.searchByGoogle);
}
exports.webSearchByGoogle = webSearchByGoogle;
function webSearchByDuckDuckGo() {
  webSearch(config_1.ConfigSections.searchByDuckDuckGo);
}
exports.webSearchByDuckDuckGo = webSearchByDuckDuckGo;
/**
 * Launches the Search URL using StackOverflow in the default browser.
 * Uses the webSearch function to perform the search.
 */
function webSearchByStackOverflow() {
  webSearch(config_1.ConfigSections.searchByStackOverflow);
}
exports.webSearchByStackOverflow = webSearchByStackOverflow;
/**
 * Launches the Search URL using Github in the default browser.
 * Uses the webSearch function to perform the search.
 */
function webSearchByGithub() {
  webSearch(config_1.ConfigSections.searchByGithub);
}
exports.webSearchByGithub = webSearchByGithub;
